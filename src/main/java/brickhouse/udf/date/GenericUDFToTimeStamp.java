...
/**
 * deterministic version of UDFTimeStamp. enforces argument
 */
@Description(name = "to_timestamp",
        value = "_FUNC_(date[, pattern]) - Returns the  timestamp",
...
public class GenericUDFToTimeStamp extends GenericUDF {
    ...
    public Object evaluate(DeferredObject[] arguments) throws HiveException {
        ...
        if (inputTextConverter != null) {
            ...
            try {
                retValue.set(formatter.parse(textVal).getTime());
                return retValue;
        ...
        retValue.set(timestamp.getTime());
        return retValue;
    }
