...
CREATE TEMPORARY FUNCTION subarraysum as 'brickhouse.udf.collect.SubArraySumUDF';
...
CREATE TEMPORARY FUNCTION firstdayofweek AS 'brickhouse.udf.date.FirstDayOfWeekUDF';
CREATE TEMPORARY FUNCTION lastdayofweek AS 'brickhouse.udf.date.LastDayOfWeekUDF';
...
CREATE TEMPORARY FUNCTION to_timestamp AS 'brickhouse.udf.date.GenericUDFToTimeStamp';
...
CREATE TEMPORARY FUNCTION mysql_import_ext AS 'brickhouse.udf.mysql.MysqlImportExtUDF';
CREATE TEMPORARY FUNCTION mysql_batch_import AS 'brickhouse.udf.mysql.MysqlBatchImportExtUDF';
